...
class AppColor {
  static Color homePageColor = const Color(0xFFfbfcff);
  ...
  static Color homePageSubtle = const Color(0xFF414160);
  static Color homePageDetail = const Color(0xFF6588f4);
  static Color homePageIcons = const Color(0xFF3b3c5c);
  static Color homePageContainerTextSmall = const Color(0xFF3b3c5c);
